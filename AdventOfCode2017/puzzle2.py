s="""4347    3350    196 162 233 4932    4419    3485    4509    4287    4433    4033    207 3682    2193    4223
...
spreadsheet=[[int(y) for y in x.split(' ')] for x in s.split('\n')]

print sum(max(x)-min(x) for x in spreadsheet)
...
print sum([quotient(row) for row in spreadsheet])